<template>
  ...
  <div>
    <cash-action v-if="tab == 'actionData'" :id="props.id" />
    <note-board v-if="tab == 'note'" :id="props.id" url="cash-note" />
    <file-board v-if="tab == 'attachment'" :id="props.id" url="cash-attachment" />
    <image-board v-if="tab == 'image'" :id="props.id" url="cash-image" />
  </div>
</template>
<script setup>
...
import CashAction from "./CashAction.vue";
