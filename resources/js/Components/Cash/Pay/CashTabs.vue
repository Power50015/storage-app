<template>
  ...
  <div>
    <note-board v-if="tab == 'note'" :id="props.id" url="cash-pay-note" />
    <file-board v-if="tab == 'attachment'" :id="props.id" url="cash-pay-attachment" />
    <image-board v-if="tab == 'image'" :id="props.id" url="cash-pay-image" />
  </div>
</template>
<script setup>
