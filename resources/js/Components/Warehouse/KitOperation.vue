    ...
    ><template #btn>
      ...
      >
        <div class="w-full">
          ...
          <template>الكميه : {{ item.quantity }}</template>
        </div>
        <div class="w-full text-center">
          <BadgeLight>
            <template v-if="item.action == 0">أعدام قطعه غيار</template>
            <template v-if="item.action == 1">أستعمال قطعه غيار</template>
          </BadgeLight>
        </div>
    ...
    <template #default>
      ...
      >
        ...
        >
          ...
          <h2 class="mb-3 font-bold">الكميه : {{ item.quantity }}</h2>
