<template>
  <DataTable class="transfer-tos" :options="options">
    <thead>
      <tr>
        <th></th>
      </tr>
    ...
    <tbody>
      <tr v-for="i in transfer_tos" :key="i.number">
        <td>
          <div
            class="
              flex
          ...
          >
            ...
            >
              ...
              <div class="text-sm">{{ i.warehouse_from.name }}</div>
            </Link>
          </div>
        </td>
      </tr>
...
const props = defineProps(["transfer_tos"]);
const transfer_tos = props.transfer_tos;
</script>
<style>
