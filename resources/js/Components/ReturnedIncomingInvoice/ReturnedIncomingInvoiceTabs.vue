<template>
  ...
  <div>
    <note-board v-if="tab == 'note'" :id="props.id" url="returned-incoming-note" />
    <file-board
      v-if="tab == 'attachment'"
      :id="props.id"
      url="returned-incoming-attachment"
    />
    <image-board v-if="tab == 'image'" :id="props.id" url="returned-incoming-image" />
  </div>
</template>
  <script setup>
