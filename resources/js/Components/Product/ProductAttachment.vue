<template>
  <div>
    <div class="flex justify-between mb-5">
      <h2 class="font-bold text-2xl my-3">الملفات</h2>
      <div
        class="
          print:hidden
          bg-[#009ef7]
    ...
    >
      <tbody>
        <tr v-for="i in attachment" :key="i.index" class="">
          <td
            class="
          ...
          >
            ...
            <div
              class="
                ...
                rounded-md
              "
              @click="deleteModelOpen(i.id, i.attachment)"
            >
            ...
            >
              ...
              >
                <h2 class="title font-bold mb-4">
                  هل أنت متاكد من حذف الملف .
                </h2>
                <a
                  :href="`/storage/${i.attachment}`"
                  class="hover:text-[#0095e8] mb-5"
                  target="_blank"
                >
                  {{ i.attachment }}
                </a>
    ...
    <div class="model" v-if="showModel">
      ...
      >
        <div
          ...
          "
        >
          <h2 class="title font-bold mb-4">إضافه ملف</h2>
...
const props = defineProps(["attachment", "id"]);
...
function addAttachment() {
  Inertia.post(route("product-attachment.store"), form, {
    onSuccess: () => {
      createToast(
        {
          title: "تم تسجيل ملاحظه الملف",
        },
        {
          timeout: 3000,
          transition: "slide",
...
function deleteAttachment(id) {
   ...
   *
   */
  Inertia.delete(route("product-attachment.destroy", id), {
    onSuccess: () => {
      createToast(
        {
          title: "تم حذف الملف",
