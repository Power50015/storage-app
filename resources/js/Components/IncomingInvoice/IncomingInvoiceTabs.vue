<template>
  ...
  <div>
    <note-board v-if="tab == 'note'" :id="props.id" url="incoming-invoice-note" />
    <file-board
      v-if="tab == 'attachment'"
      :id="props.id"
      url="incoming-invoice-attachment"
    />
    <image-board v-if="tab == 'image'" :id="props.id" url="incoming-invoice-image" />
  </div>
</template>
  <script setup>
