    ...
    <div class="py-6">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div
          ...
          "
        >
          <h2 class="title font-bold mb-4">أضافه دين</h2>
...
const props = defineProps(["errors", "companies"]);
...
function addDebtor() {
  Inertia.post(route("debtor.store"), debtorAddForm, {
    onSuccess: () => {
      createToast(
        {
          title: "تم تسجيل الدين " ,
          description: " تم تسجيل الدين ",
        },
        {
          timeout: 3000,
          transition: "slide",
