<template>
  <AppLayout title="إضافه مرتجع وارده">
    <FormSection
...
const form = reactive({
  id: props.returnedIncomingInvoice ? props.returnedIncomingInvoice[0].id : null,
  _method: props.returnedIncomingInvoice ? "patch" : "post",
  route: props.returnedIncomingInvoice ? "returned-incoming-invoice.update" : "returned-incoming-invoice.store",
  people_id: props.returnedIncomingInvoice ? props.returnedIncomingInvoice[0].people_id : null,
  warehouse_id: props.returnedIncomingInvoice ? props.returnedIncomingInvoice[0].warehouse_id : null,
  pay_type: props.returnedIncomingInvoice ? props.returnedIncomingInvoice[0].pay_type : 0,
  cash_id: props.returnedIncomingInvoice ? props.returnedIncomingInvoice[0].cash_id : null,
  date: props.returnedIncomingInvoice
    ? new Date(props.returnedIncomingInvoice[0].date).toISOString().slice(0, 10)
    : new Date().toISOString().slice(0, 10),
  discount: props.returnedIncomingInvoice ? props.returnedIncomingInvoice[0].discount : 0,
  content: props.returnedIncomingInvoice ? props.returnedIncomingInvoiceContent : [],
  kit: props.returnedIncomingInvoice ? props.returnedIncomingInvoiceKit : [],
  total: 0,
});
...
if (props.invoice) {
  provide(
    ...
    readonly([
      ...
      {
        index: 2,
        linkTitle: " تعديل مرتجع وارده " + props.returnedIncomingInvoice[0].number,
        linkRoute: "#",
      },
    ])
  );
...
const formText = reactive({
  title: props.returnedIncomingInvoice ? "تعديل بيانات  مرتجع وارده" : "إضافه  مرتجع وارده ",
  btnTitle: props.returnedIncomingInvoice ? "تعديل  مرتجع وارده" : "إضافه  مرتجع وارده",
  formText: props.returnedIncomingInvoice ? "تم تعديل  مرتجع وارده" : "تم أضافه  مرتجع وارده",
});
