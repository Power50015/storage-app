  ...
  <AppLayout title="مرتجع الصادره">
    ...
    <SectionTemplate>
      ...
      <table class="min-w-max w-full table-auto mt-5">
        <tbody>
          <tr class="text-right" v-for="item in returned_outgoing_invoices.data" :key="item.index">
            ...
            <td class="py-3 px-6 text-left">
              <div class="flex items-left justify-end">
                ...
                <Link :href="route('returned-outgoing-invoice.show', item.id)" class="hover:text-[#009ef7]">
