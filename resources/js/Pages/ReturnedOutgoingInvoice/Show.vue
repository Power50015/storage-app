<template>
  <AppLayout title="مرتجع الصادره">
    ...
    <SectionTemplate class="print:p-0 print:hidden">
      <ReturnedOutgoingInvoiceTabs :id="returned_outgoing_invoice.id" />
    </SectionTemplate>
  </AppLayout>
</template>
...
import ReturnedOutgoingInvoiceTabs from "@/Components/ReturnedOutgoingInvoice/ReturnedOutgoingInvoiceTabs.vue";
