<template>
  <AppLayout title="إضافه مرتجع صادره">
    <FormSection
    ...
    >
      ...
      <div class="mb-10 dark:bg-[#fefefe0d] dark:border-0 border py-7 px-3">
        ...
        <div class="flex items-end justify-around">
          ...
          <div class="">
            <label class="px-3 dark:text-gray-300"> خصم على البيان </label
            ><input
              type="number"
              min="0.00"
              step="0.01"
...
const form = reactive({
  id: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoice[0].id : null,
  _method: props.returnedOutgoingInvoice ? "patch" : "post",
  route: props.returnedOutgoingInvoice ? "returned-outgoing-invoice.update" : "returned-outgoing-invoice.store",
  people_id: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoice[0].people_id : null,
  warehouse_id: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoice[0].warehouse_id : null,
  pay_type: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoice[0].pay_type : 0,
  cash_id: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoice[0].cash_id : null,
  date: props.returnedOutgoingInvoice
    ? new Date(props.returnedOutgoingInvoice[0].date).toISOString().slice(0, 10)
    : new Date().toISOString().slice(0, 10),
  discount: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoice[0].discount : 0,
  content: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoiceContent : [],
  kit: props.returnedOutgoingInvoice ? props.returnedOutgoingInvoiceKit : [],
  total: 0,
});
...
if (props.invoice) {
  provide(
    ...
    readonly([
      ...
      {
        index: 2,
        linkTitle: " تعديل مرتجع صادره " + props.returnedOutgoingInvoice[0].number,
        linkRoute: "#",
      },
    ])
  );
...
const formText = reactive({
  title: props.returnedOutgoingInvoice ? "تعديل بيانات  مرتجع صادره" : "إضافه  مرتجع صادره ",
  btnTitle: props.returnedOutgoingInvoice ? "تعديل  مرتجع صادره" : "إضافه  مرتجع صادره",
  formText: props.returnedOutgoingInvoice ? "تم تعديل  مرتجع صادره" : "تم أضافه  مرتجع صادره",
});
