        ...
        >
          ...
          <form action="POST" @submit.prevent="addKit">
            ...
            >
              ...
              <div v-for="(i, index) in kitAddForm.images" :key="index">
                <div class="w-full my-5">
                  <h3>{{ 1 + index }}</h3>
                  <label class="px-3 dark:text-gray-300"
                    >الصورة
                  ...
                  <div class="flex">
                    <input
                      ...
                      type="file"
                      @change="
                        kitAddForm.images[index].image = $event.target.files[0]
                      "
                    />
                    <!-- Delete -->
                    <div class="mb-5">
                      <div
                        ...
                        "
                        @click="
                          kitAddForm.images = kitAddForm.images.filter(
                            (item) => item.id != i.id
                          )
                        "
                      >
                ...
                <hr
                  v-if="
                    kitAddForm.images.length > 1 &&
                    kitAddForm.images.length != index
                  "
                />
              </div>
            ...
            >
              ...
              <div v-for="(i, index) in kitAddForm.note" :key="index">
                <div class="w-full my-5">
                  <h3>{{ 1 + index }}</h3>
                  <label class="px-3 dark:text-gray-300"
                    >الملاحظه
                  ...
                  <div class="">
                    <div class="mb-5">
                      ...
                      >
                        <QuillEditor
                          theme="snow"
                          toolbar="minimal"
                          v-model:content="kitAddForm.note[index].note"
                          contentType="html"
                        />
                      </div>
                    </div>
                    ...
                    <div class="mb-5">
                      <div
                        ...
                        "
                        @click="
                          kitAddForm.note = kitAddForm.note.filter(
                            (item) => item.id != i.id
                          )
                        "
                      >
                ...
                <hr
                  v-if="
                    kitAddForm.note.length > 1 &&
                    kitAddForm.note.length != index
                  "
                />
              </div>
...
function pushToNote() {
  kitAddForm.note.push({
    id: kitAddForm.attachment.length + 1,
    note: null,
  });
}
function pushToImage() {
  kitAddForm.images.push({
    id: kitAddForm.images.length + 1,
    image: null,
  });
}
