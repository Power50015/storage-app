<template>
  <AppLayout title="تعديل فاتوره صادره">
    <div class="py-6">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        >
          ...
          <form action="POST" @submit.prevent="addOutgoingInvoice">
            ...
            <div class="mb-5">
              <label class="px-3 dark:text-gray-300"> رقم الفاتوره </label>
              <h3 class="px-4 dark:text-gray-300">{{ outgoingInvoiceAddForm.id }}</h3>
            </div>
            <!-- Supplier -->
            <div class="mb-5">
              ...
              <div v-if="errors.people" class="text-red-800">
                {{ errors.people }}
              </div>
              <select
                v-model="outgoingInvoiceAddForm.people"
                class="
                  w-full
                  text-base
                  dark:bg-[#1b1b29]
            ...
            >
              ...
              <div
                v-for="(i, index) in outgoingInvoiceAddForm.oldAttachment"
                :key="index"
              >
                <div class="w-full my-5">
                  ...
                  <div class="flex justify-between">
                    {{ outgoingInvoiceAddForm.oldAttachment[index].attachment }}
                    <!-- Delete -->
                    <div class="mb-5">
                      <div
                        class="
                        ...
                        "
                        @click="
                          outgoingInvoiceAddForm.oldAttachment =
                            outgoingInvoiceAddForm.oldAttachment.filter(
                              (item) => item.id != i.id
                            )
                        "
                      >
                ...
                <hr
                  v-if="
                    outgoingInvoiceAddForm.oldAttachment.length > 1 &&
                    outgoingInvoiceAddForm.oldAttachment.length != index
                  "
                />
              </div>
              <div
            ...
            >
              ...
              >
                <div class="w-full my-5">
                  ...
                  <select
                    v-model="outgoingInvoiceAddForm.content[index].product_id"
                    class="
                      w-full
                      text-base
                      dark:bg-[#1b1b29]
...
const outgoingInvoiceAddForm = reactive({
  ...
  oldAttachment: props.outgoingInvoiceAttachment,
  attachment: [],
});
...
provide(
  ...
  readonly([
    ...
    {
      index: 2,
      linkTitle: "تعديل فاتوره وارده رقم : " + outgoingInvoiceAddForm.id,
      linkRoute: "#",
    },
  ])
);
function addOutgoingInvoice() {
   ...
   */
  Inertia.post(
    route("outgoing-invoice.update", outgoingInvoice.id),
        ...
        createToast(
          {
            ...
            description: " تم تعديل الفاتوره " + outgoingInvoiceAddForm.id,
          },
          {
            timeout: 3000,
            transition: "slide",
