    ...
    <SectionTemplate class="pb-0">
      <div class="header">
        ...
        <div class="flex justify-between my-3">
          ...
          <Link :href="route('warehouse.show', outgoing_invoice.people.id)" class="hover:text-[#009ef7]">
          <h2 class="px-2 print:mb-3 print:hidden">
            المخزن : {{ outgoing_invoice.warehouse.name }}
          </h2>
          </Link>
        </div>
        <div class="flex justify-between my-3">
          <Link :href="route('people.show', outgoing_invoice.people.id)" class="hover:text-[#009ef7]">
          <h2 class="px-2 print:mb-3">
        ...
        <div class="flex justify-between my-3">
          ...
          <h2 class="" v-if="outgoing_invoice.pay_type == 1 && outgoing_invoice.cash">
      ...
      <div class="invoice">
        ...
        <table class="border border-slate-700 w-full text-right">
          ...
          <tbody>
            ...
            <tr v-for="product in outgoingInvoiceContent" :key="product.index" class="">
